...
[source,bash,subs="attributes+,+macros"]
----
kubectl apply -f documentation/modules/ROOT/examples/welcome-php/welcome-hooks.yaml
----
...
[source,bash,subs="attributes+,+macros"]
----
kubectl apply -f documentation/modules/ROOT/examples/welcome-php/welcome-syncwaves-and-hooks.yaml
----
