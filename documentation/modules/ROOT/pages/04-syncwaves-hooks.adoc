...
[source,bash,subs="attributes+,+macros"]
----
kubectl apply -f d46182
ocumentation/modules/ROOT/examples/minikube/syncwaves-hooks/welcome-syncwaves.yaml
----
--
OpenShift::
+
...
manifests. You can see the specific implementation in the https://github.com/redhat-developer-demos/openshift-gitops-examples/tree/minikube/apps/welcome-php/overlays/syncwaves-and-hooks[git repo]
